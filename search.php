...
<div style="margin-bottom: 10%"><br><center><button onclick="window.location='index.php'"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Back</button></center><br><br>
</div>
